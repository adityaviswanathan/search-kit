...
def main():
    ...
    groupS.add_argument("-r", "--raw", action="store_true",
                        help="analyze a raw Wiki string")
    ...
    if args.raw:
        import re, string
        maybe_title = re.sub('[\W_]+', '', args.input.split(' ', 1)[0])
        Extractor(1, maybe_title, args.input.decode('utf-8')).extract(sys.stdout)
        return
